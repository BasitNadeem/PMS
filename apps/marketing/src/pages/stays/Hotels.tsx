...
export default function Hotels() {
  return (
    <StayTypeTemplate
      ...
      intro="Boutique, motel, resort, or a handful of properties under one brand — InnFlo runs reservations, billing, and housekeeping from a single dashboard."
      ...
      benefits={{
        ...
        items: [
          ...
          { icon: RefreshCcw, title: "Be seen everywhere", body: "Channel Manager syncs availability across Booking.com, Airbnb, Expedia, and Agoda, so guests find you wherever they search.", image: "/images/benefits/channel.webp" },
      ...
      faqs={[
        { q: "Is InnFlo built for large chains or independent hotels?", a: "Independent and small multi-property hotels — InnFlo is priced and built for properties that don't fit the enterprise template, not hundred-hotel chains." },
