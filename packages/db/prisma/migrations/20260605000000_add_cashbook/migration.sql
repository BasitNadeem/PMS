...
CREATE INDEX cash_accounts_hotel_id_idx 
  ON cash_accounts(hotel_id);
CREATE INDEX ledger_entries_hotel_id_idx 
  ON ledger_entries(hotel_id);
CREATE INDEX ledger_entries_account_id_idx 
  ON ledger_entries(account_id);
CREATE INDEX ledger_entries_hotel_date_idx 
  ON ledger_entries(hotel_id, entry_date DESC);
