...
const PAIRED_PERMISSION_KEYS: Record<string, string[]> = {
  ...
  "companies:read":        ["COMPANY_READ"],
  "companies:create":      ["COMPANY_CREATE"],
  "companies:update":      ["COMPANY_UPDATE"],
  "companies:delete":      ["COMPANY_DELETE"],
  "companies:creditLimit": ["COMPANY_CREDIT_LIMIT"],
  "companies:post":        ["COMPANY_LEDGER_POST"],
  "companies:payment":     ["COMPANY_PAYMENT"],
  "companies:writeOff":    ["COMPANY_WRITE_OFF"],
  "companies:invoice":     ["COMPANY_INVOICE"],
  ...
  "bookingEngine:read":  ["BOOKING_ENGINE_READ", "UPSELL_READ"],
  "bookingEngine:manage": ["UPSELL_CREATE", "UPSELL_UPDATE", "UPSELL_DELETE"],
